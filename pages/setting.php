    ...
    filter: drop-shadow(3px 3px 2px #222222);" />
          ...
          <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
            <ul class="navbar-nav flex-column">
              ...
              <li class="nav-item"><a class="nav-link" href="#pages" data-toggle="collapse" role="button" >
        ...
        <!-- <div class="content">
          ...
          <div class="row no-gutters">
            ...
            <div class="col-lg-12 pr-lg-12 mb-3">
              <div class="card">
                <div class="card-header">
                  <div class="row justify-content-between align-items-center">
                    <div class="col-md">
                      <h5 class="mb-2 mb-md-0">Scan QR Code</h5>
                    </div>
                    <div class="col-auto">
                      <button class="btn btn-falcon-default btn-sm mr-2" role="button">Get QRCode</button>
                      <button class="btn btn-falcon-primary btn-sm" role="button">Test Send Message</button>
                    </div>
                  </div>
                </div>
                <div class="card-body">
                  <form class="row">
                    <div class="col">
                      <img src="../assets/img/scanqr.png" style="width: 100%">
                    </div>
                  </form>
                </div>
              </div>
          ...
          <div class="row no-gutters">
                ...
                <div class="bg-light card-body"> 
                  <div class="form-group">
                    <div class="form-row">
                        <div class="col">
                          <div class="form-group">
                            <label class="ls text-uppercase text-600 font-weight-semi-bold mb-0" for="cardNumber">Open At</label>
                            <input class="form-control" id="cardName" placeholder="08:00" type="text">
                          </div>
                        </div>
                        <div class="col">
                          <div class="form-group">
                            <label class="ls text-uppercase text-600 font-weight-semi-bold mb-0" for="cardName">Close At</label>
                            <input class="form-control" id="cardName" placeholder="16:00" type="text">
                          </div>
                        </div>
                      </div>
                  </div>
                  <div class="form-group">
                      ...
                      <small class="form-text fs--1 text-warning">This message will be sent when a message arrives outside office hours</small>
                  </div>
            ...
            <div class="col-lg-6 pl-lg-2 mb-3">
              <div class="card">
                <div class="card-header">
                  <h5 class="mb-0">Device Setup</h5>
                </div>
                <div class="bg-light card-body">
                  <div class="form-group">
                    <label for="field-name">Device ID</label>
                    <input class="form-control form-control-sm" id="field-name" type="text" placeholder="" disabled value="XIAUI">
                  </div>
                  <div class="form-group">
                    <label for="field-name">WA Number</label>
                    <input class="form-control form-control-sm" id="field-name" type="text" placeholder="Your WA Number" value="62349573402">
                    <small class="form-text fs--1 text-warning">* This number used for sent and received message</small>
                  </div>
                  <div class="form-group">
                    <label for="field-name">Token</label>
                    <input class="form-control form-control-sm" id="field-name" type="text" placeholder="" disabled value="FrZBxQJSw6hLgD9XuZelYgQGpD6C0z0UbT6O44OSPnZk8cXNFpr2QBp3BV9UCpH3">
                    <small class="form-text fs--1 text-warning">* The following token that you can use to make service to our server</small>
                  </div>
                  <div class="form-group">
                    <label for="field-name">Webhook URL</label>
                    <input class="form-control form-control-sm" id="field-name" type="text" placeholder="https://abx.com/script.php" value="">
                    <small class="form-text fs--1 text-warning">* Webhook URLs that will capture new messages to WhatsApp from other numbers</small>
                  </div>
                  <hr class="border-dashed border-bottom-0">
                  <div class="col-auto">
                    <button class="btn btn-falcon-default btn-sm mr-2" role="button">Save</button>
