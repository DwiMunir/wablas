          ...
          <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
            <ul class="navbar-nav flex-column">
              ...
              <li class="nav-item"><a class="nav-link dropdown-indicator" href="#email" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="email">
                ...
                <ul class="nav collapse show" id="email" data-parent="#navbarVerticalCollapse">
                  <li class="nav-item active"><a class="nav-link" href="/wablas/pages/status.php">Message Status</a>
                  </li>
                            ...
                            <table class="table table-sm fs--1">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="" class="btn btn-danger btn-sm fs--2 text-white">not registered</a>
                                        </td>
                                        <td>text</td>
                                        <td>
                                            <a href="" class="btn bg-700 text-white fs--2">remove</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>1</td>
